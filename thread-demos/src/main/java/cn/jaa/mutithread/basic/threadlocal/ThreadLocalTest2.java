package cn.jaa.mutithread.basic.threadlocal;
...
public class ThreadLocalTest2 {
    ...
    public void testMemLeak() throws InterruptedException {
        ...
        Print.tcfo("GC前 key => " + Foo.threadLocalKey(threadRef));
        Print.tcfo("GC前 threadLocal object => " + Foo.threadLocalGet(threadRef));
        ...
        Print.tcfo("GC后 key  => " + Foo.threadLocalKey(threadRef));
        Print.tcfo("GC后 threadLocal object  => " + Foo.threadLocalGet(threadRef));
    }
}
